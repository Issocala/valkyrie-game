...
public record UnitSelectorTemplate(int id,String name,int unit_limit,String sort_by,int use_circle_area,String center,float range_min,float range_max,float angle_min,float angle_max,int use_rect_area,float max_x,float min_x,float max_y,float min_y,String condition,int[] unit_id,int[] unit_type,int[] not_in_unit_type,int[] unit_team){
    ...
    public static UnitSelectorTemplate parse(CustomByteBuffer cbb){
        ...
        var temp = new UnitSelectorTemplate(id,name,unit_limit,sort_by,use_circle_area,center,range_min,range_max,angle_min,angle_max,use_rect_area,max_x,min_x,max_y,min_y,condition,unit_id,unit_type,not_in_unit_type,unit_team);
        return temp;
    }
}
