...
public record SkillStepTemplate(int id,String name,int time_start_in_ms,int time_end_in_ms,int delta_time_in_ms,String condition,int check_buff,int config_group_type,int select_target,String select_target_group,String set_pos,String x_move_speed,String y_move_speed,int jump_in_air,int no_check_land_time_in_ms,int check_ladder_time_in_ms,float turn_speed,String face_dir,int summon_unit_id,String summon_pos,String summon_face,int summon_skill,String summon_skill_param,int control_unit,int end_self_skill,int break_this_frame,int cast_skill,String play_anim,float anim_crossfade_time,float anim_speed,String set_param_name,String set_param_formula,String action_group,int repeat_action,int hp_damage_type,String hp_damage,String mana,int add_buff,int buff_time_in_ms,int remove_buff,String partical_effect_name,String lightning_name,String lightning_pos_1,String lightning_pos_2,String log_string){
    ...
    public static SkillStepTemplate parse(CustomByteBuffer cbb){
        ...
        var temp = new SkillStepTemplate(id,name,time_start_in_ms,time_end_in_ms,delta_time_in_ms,condition,check_buff,config_group_type,select_target,select_target_group,set_pos,x_move_speed,y_move_speed,jump_in_air,no_check_land_time_in_ms,check_ladder_time_in_ms,turn_speed,face_dir,summon_unit_id,summon_pos,summon_face,summon_skill,summon_skill_param,control_unit,end_self_skill,break_this_frame,cast_skill,play_anim,anim_crossfade_time,anim_speed,set_param_name,set_param_formula,action_group,repeat_action,hp_damage_type,hp_damage,mana,add_buff,buff_time_in_ms,remove_buff,partical_effect_name,lightning_name,lightning_pos_1,lightning_pos_2,log_string);
        return temp;
    }
}
