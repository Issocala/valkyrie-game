...
public record BuffDataTemplate(int id, String name, int config_group_type, int interval_in_ms, int[] old_status,
                               int[] new_status, String shield_value, int spec_effect, int trig_skill,
                               int skill_user_is_creator) {
