...
public record FightSkillTemplate(int id,byte skillType,byte activeSkillType,byte skillTargetType,byte skillAimType,long cdTime,int costHp,int costMp,int[] skillProcess,int skillGroup){
    ...
    public static FightSkillTemplate parse(CustomByteBuffer cbb){
        ...
        var skillGroup = cbb.getInt();

        var temp = new FightSkillTemplate(id,skillType,activeSkillType,skillTargetType,skillAimType,cdTime,costHp,costMp,skillProcess,skillGroup);
        return temp;
    }
}
