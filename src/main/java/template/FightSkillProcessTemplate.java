...
public record FightSkillProcessTemplate(int id, long delayTime, byte skillTargetType, byte skillAimType,
                                        String parameter, String attributeParameter, String function) {
