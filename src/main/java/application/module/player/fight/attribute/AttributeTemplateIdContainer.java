...
public class AttributeTemplateIdContainer {
     ...
     * 全部属性ID集合
     */
    public final static Set<Short> ALL = new HashSet<>();
    /**
     * 值类型属性集合
     */
    public final static Set<Short> VALUE = new HashSet<>();
    /**
     * 比例类型属性集合
     */
    public final static Set<Short> RATIO = new HashSet<>();

    /**
     * 子属性 -> 全局属性
     */
    public final static Map<Short, Short> VALUE_PUBLIC = new HashMap<>();

    /**
     * 全局百分比加成 -> 受加成的值集合
     */
    public final static Map<Short, Set<Short>> PUBLIC_BASE = new HashMap<>();

    /**
     * 子系统模块百分比加成 -> 受加仓的值集合
     */
    public final static Map<Short, Set<Short>> PART_RATIO_VALUE = new HashMap<>();
