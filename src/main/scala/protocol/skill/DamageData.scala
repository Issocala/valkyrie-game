...
final case class DamageData(
    ...
    reduceMP: _root_.scala.Option[_root_.scala.Long] = _root_.scala.None,
    ...
    private[this] def __computeSerializedValue(): _root_.scala.Int = {
      ...
      if (reduceMP.isDefined) {
        val __value = reduceMP.get
    ...
    def getReduceMP: _root_.scala.Long = reduceMP.getOrElse(0L)
    def clearReduceMP: DamageData = copy(reduceMP = _root_.scala.None)
    def withReduceMP(__v: _root_.scala.Long): DamageData = copy(reduceMP = Option(__v))
    ...
    def getField(__field: _root_.scalapb.descriptors.FieldDescriptor): _root_.scalapb.descriptors.PValue = {
      ...
      (__field.number: @_root_.scala.unchecked) match {
        ...
        case 4 => reduceMP.map(_root_.scalapb.descriptors.PLong(_)).getOrElse(_root_.scalapb.descriptors.PEmpty)
      }
    }
...
object DamageData extends scalapb.GeneratedMessageCompanion[protocol.skill.DamageData] with scalapb.HasBuilder[protocol.skill.DamageData] with scalapb.JavaProtoSupport[protocol.skill.DamageData, protocol.Skill.DamageData] {
  ...
  def toJavaProto(scalaPbSource: protocol.skill.DamageData): protocol.Skill.DamageData = {
    ...
    scalaPbSource.reduceMP.foreach(javaPbOut.setReduceMP)
    javaPbOut.build
  }
  def fromJavaProto(javaPbSource: protocol.Skill.DamageData): protocol.skill.DamageData = protocol.skill.DamageData(
    ...
    reduceMP = if (javaPbSource.hasReduceMP) Some(javaPbSource.getReduceMP.longValue) else _root_.scala.None
  )
  ...
  implicit def messageReads: _root_.scalapb.descriptors.Reads[protocol.skill.DamageData] = _root_.scalapb.descriptors.Reads{
    case _root_.scalapb.descriptors.PMessage(__fieldsMap) =>
      ...
      protocol.skill.DamageData(
        ...
        reduceMP = __fieldsMap.get(scalaDescriptor.findFieldByNumber(4).get).flatMap(_.as[_root_.scala.Option[_root_.scala.Long]])
      )
  ...
  final class Builder private (
    ...
    private var __reduceMP: _root_.scala.Option[_root_.scala.Long],
    ...
    def merge(`_input__`: _root_.com.google.protobuf.CodedInputStream): this.type = {
      ...
      while (!_done__) {
        ...
        _tag__ match {
          ...
          case 32 =>
            __reduceMP = Option(_input__.readInt64())
          case tag =>
  ...
  object Builder extends _root_.scalapb.MessageBuilderCompanion[protocol.skill.DamageData, protocol.skill.DamageData.Builder] {
    ...
    def apply(`_message__`: protocol.skill.DamageData): Builder = new Builder(
        ...
        __reduceMP = _message__.reduceMP,
  ...
  implicit class DamageDataLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, protocol.skill.DamageData]) extends _root_.scalapb.lenses.ObjectLens[UpperPB, protocol.skill.DamageData](_l) {
    ...
    def reduceMP: _root_.scalapb.lenses.Lens[UpperPB, _root_.scala.Long] = field(_.getReduceMP)((c_, f_) => c_.copy(reduceMP = Option(f_)))
    def optionalReduceMP: _root_.scalapb.lenses.Lens[UpperPB, _root_.scala.Option[_root_.scala.Long]] = field(_.reduceMP)((c_, f_) => c_.copy(reduceMP = f_))
  }
  final val TARGETID_FIELD_NUMBER = 1
  final val DAMAGETYPE_FIELD_NUMBER = 2
  final val DAMAGE_FIELD_NUMBER = 3
  final val REDUCEMP_FIELD_NUMBER = 4
  def of(
    targetId: _root_.scala.Long,
    damageType: _root_.scala.Int,
    damage: _root_.scala.Long,
    reduceMP: _root_.scala.Option[_root_.scala.Long]
