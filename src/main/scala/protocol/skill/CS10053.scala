...
final case class CS10053(
    ...
    def withFightOrganismId(__v: _root_.scala.Long): CS10053 = copy(fightOrganismId = __v)
    def withSkillId(__v: _root_.scala.Int): CS10053 = copy(skillId = __v)
    def clearTargetId = copy(targetId = _root_.scala.Seq.empty)
    def addTargetId(__vs: _root_.scala.Long*): CS10053 = addAllTargetId(__vs)
    def addAllTargetId(__vs: Iterable[_root_.scala.Long]): CS10053 = copy(targetId = targetId ++ __vs)
    def withTargetId(__v: _root_.scala.Seq[_root_.scala.Long]): CS10053 = copy(targetId = __v)
    def getTimestamp: _root_.scala.Long = timestamp.getOrElse(0L)
    def clearTimestamp: CS10053 = copy(timestamp = _root_.scala.None)
    def withTimestamp(__v: _root_.scala.Long): CS10053 = copy(timestamp = Option(__v))
    def withSkillOrganismId(__v: _root_.scala.Int): CS10053 = copy(skillOrganismId = __v)
    ...
    def getField(__field: _root_.scalapb.descriptors.FieldDescriptor): _root_.scalapb.descriptors.PValue = {
      ...
      (__field.number: @_root_.scala.unchecked) match {
        ...
        case 4 => timestamp.map(_root_.scalapb.descriptors.PLong(_)).getOrElse(_root_.scalapb.descriptors.PEmpty)
  ...
  implicit def messageReads: _root_.scalapb.descriptors.Reads[protocol.skill.CS10053] = _root_.scalapb.descriptors.Reads{
    case _root_.scalapb.descriptors.PMessage(__fieldsMap) =>
      ...
      protocol.skill.CS10053(
        ...
        timestamp = __fieldsMap.get(scalaDescriptor.findFieldByNumber(4).get).flatMap(_.as[_root_.scala.Option[_root_.scala.Long]]),
