...
final case class SC10055(
    ...
    ) extends scalapb.GeneratedMessage with scalapb.lenses.Updatable[SC10055] {
    ...
    def withFightOrganismId(__v: _root_.scala.Long): SC10055 = copy(fightOrganismId = __v)
    def withSkillProcessId(__v: _root_.scala.Int): SC10055 = copy(skillProcessId = __v)
    def clearTargetId = copy(targetId = _root_.scala.Seq.empty)
    def addTargetId(__vs: _root_.scala.Long*): SC10055 = addAllTargetId(__vs)
    def addAllTargetId(__vs: Iterable[_root_.scala.Long]): SC10055 = copy(targetId = targetId ++ __vs)
    def withTargetId(__v: _root_.scala.Seq[_root_.scala.Long]): SC10055 = copy(targetId = __v)
    def withSkillOrganismId(__v: _root_.scala.Int): SC10055 = copy(skillOrganismId = __v)
    ...
    def companion = protocol.skill.SC10055
    // @@protoc_insertion_point(GeneratedMessage[protocol.SC10055])
}

object SC10055 extends scalapb.GeneratedMessageCompanion[protocol.skill.SC10055] with scalapb.HasBuilder[protocol.skill.SC10055] with scalapb.JavaProtoSupport[protocol.skill.SC10055, protocol.Skill.SC10055] {
  implicit def messageCompanion: scalapb.GeneratedMessageCompanion[protocol.skill.SC10055] with scalapb.HasBuilder[protocol.skill.SC10055] with scalapb.JavaProtoSupport[protocol.skill.SC10055, protocol.Skill.SC10055] = this
  def toJavaProto(scalaPbSource: protocol.skill.SC10055): protocol.Skill.SC10055 = {
    val javaPbOut = protocol.Skill.SC10055.newBuilder
  ...
  def fromJavaProto(javaPbSource: protocol.Skill.SC10055): protocol.skill.SC10055 = protocol.skill.SC10055(
  ...
  def merge(`_message__`: protocol.skill.SC10055, `_input__`: _root_.com.google.protobuf.CodedInputStream): protocol.skill.SC10055 = newBuilder(_message__).merge(_input__).result()
  implicit def messageReads: _root_.scalapb.descriptors.Reads[protocol.skill.SC10055] = _root_.scalapb.descriptors.Reads{
  ...
  def javaDescriptor: _root_.com.google.protobuf.Descriptors.Descriptor = SkillProto.javaDescriptor.getMessageTypes().get(12)
  def scalaDescriptor: _root_.scalapb.descriptors.Descriptor = SkillProto.scalaDescriptor.messages(12)
  def messageCompanionForFieldNumber(__number: _root_.scala.Int): _root_.scalapb.GeneratedMessageCompanion[_] = throw new MatchError(__number)
  lazy val nestedMessagesCompanions: Seq[_root_.scalapb.GeneratedMessageCompanion[_ <: _root_.scalapb.GeneratedMessage]] = Seq.empty
  def enumCompanionForFieldNumber(__fieldNumber: _root_.scala.Int): _root_.scalapb.GeneratedEnumCompanion[_] = throw new MatchError(__fieldNumber)
  lazy val defaultInstance = protocol.skill.SC10055(
    fightOrganismId = 0L,
    skillProcessId = 0,
  ...
  final class Builder private (
  ...
  ) extends _root_.scalapb.MessageBuilder[protocol.skill.SC10055] {
    ...
    def result(): protocol.skill.SC10055 = {
  ...
  object Builder extends _root_.scalapb.MessageBuilderCompanion[protocol.skill.SC10055, protocol.skill.SC10055.Builder] {
    ...
    def apply(`_message__`: protocol.skill.SC10055): Builder = new Builder(
  ...
  def newBuilder: Builder = protocol.skill.SC10055.Builder()
  def newBuilder(`_message__`: protocol.skill.SC10055): Builder = protocol.skill.SC10055.Builder(_message__)
  implicit class SC10055Lens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, protocol.skill.SC10055]) extends _root_.scalapb.lenses.ObjectLens[UpperPB, protocol.skill.SC10055](_l) {
  ...
  def of(
    ...
    skillOrganismId: _root_.scala.Int
  ): _root_.protocol.skill.SC10055 = _root_.protocol.skill.SC10055(
    fightOrganismId,
    skillProcessId,
    targetId,
    skillOrganismId
  )
  // @@protoc_insertion_point(GeneratedMessageCompanion[protocol.SC10055])
}
